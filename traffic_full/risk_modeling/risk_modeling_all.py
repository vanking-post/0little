...
def main():
    ...
    run_shap_analysis(rr, MODELS, 'shap_all')
    plot_comparison(fm, rr, MODELS, '全量数据模型性能对比', '09_all_model_comparison.png')
    plot_confusion(rr, MODELS, '全量数据混淆矩阵 (随机划分)', '10_all_confusion_matrices.png')
