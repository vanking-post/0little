"""
变道风险预测建模（排除 location5 + SMOTE 过采样）
=== 配置 ===
...
def main():
    ...
    run_shap_analysis(rr, MODELS, 'shap_no5_smote')
    plot_comparison(fm, rr, MODELS, '排除 Loc5 + SMOTE 模型性能对比', '11_no5_smote_comparison.png')
    plot_confusion(rr, MODELS, '排除 Loc5 + SMOTE 混淆矩阵 (随机划分)', '12_no5_smote_confusion.png')
