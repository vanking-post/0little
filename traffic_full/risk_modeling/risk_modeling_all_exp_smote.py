...
def main():
    ...
    run_shap_analysis(rr, MODELS, 'shap_exp_smote')
    plot_comparison(fm, rr, MODELS, 'exp 评分 + SMOTE 模型性能对比', '09_exp_smote_comparison.png')
    plot_confusion(rr, MODELS, 'exp 评分 + SMOTE 混淆矩阵 (随机划分)', '10_exp_smote_confusion.png')
    ...
    try:
        ...
        plot_cross_location_radar(fm, MODELS, '09_exp_smote_cross_location_radar.png', out_dir=OUT_DIR)
        plot_random_split_radar(rr, MODELS, '09_exp_smote_random_split_radar.png', out_dir=OUT_DIR, stability_vals=stability)
        plot_xgboost_per_location_radar(fm, LOC_KEYS, '09_exp_smote_xgboost_radar.png', out_dir=OUT_DIR)
