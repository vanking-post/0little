...
def main():
    ...
    run_shap_analysis(rr, MODELS, 'shap_no5')
    plot_comparison(fm, rr, MODELS, '排除 Location5 模型性能对比', '09_no5_model_comparison.png')
    plot_confusion(rr, MODELS, '排除 Location5 混淆矩阵 (随机划分)', '10_no5_confusion_matrices.png')
