...
def main():
    ...
    try:
        ...
        plot_cross_location_radar(fm, MODELS, '09_no5_exp_cross_location_radar.png', out_dir=OUT_DIR)
        plot_random_split_radar(rr, MODELS, '09_no5_exp_random_split_radar.png', out_dir=OUT_DIR, stability_vals=stability)
        plot_xgboost_per_location_radar(fm, LOC_KEYS, '09_no5_exp_xgboost_radar.png', out_dir=OUT_DIR)
