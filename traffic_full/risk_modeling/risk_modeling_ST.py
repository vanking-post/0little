...
def main():
    ...
    run_shap_analysis(rr, MODELS, 'shap_ST')
    plot_comparison(fm, rr, MODELS, '全量 + SMOTE + Optuna 模型性能对比', '09_ST_comparison.png')
    plot_confusion(rr, MODELS, '全量 + SMOTE + Optuna 混淆矩阵 (随机划分)', '10_ST_confusion.png')
