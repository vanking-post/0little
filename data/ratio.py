...
west_pkl_processed_path = os.path.join(save_dir, "traffic_flows_west_processed.pkl")
west_csv_processed1_path = os.path.join(save_dir, "traffic_flows_west_processed1.csv")
west_pkl_path = os.path.join(save_dir, "traffic_flows_west.pkl")
ratio_output_path = os.path.join(save_dir, "traffic_flows_ratio.csv")
...
ratio_df['count_diff'] = abs(ratio_df['processed_count'] - ratio_df['original_count'])
...
# 保存过滤后的数据到原路径
filtered_traffic_flows.to_csv(west_csv_processed1_path)
